...
This Worker is the v1.5.0 operational-state backend foundation. It stores workspace state only: users, devices, projects, sessions, locks, activity events, handoff notes, repo status snapshots, sync metadata, and settings.
